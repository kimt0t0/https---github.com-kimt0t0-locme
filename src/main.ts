...
import { faGlobe, faXmark, faPencil, faFloppyDisk, faSortDown, faSortUp, faLocationDot, faEyeSlash, faEye, faTrash, faTriangleExclamation } from '@fortawesome/free-solid-svg-icons'
...
library.add(faGlobe, faXmark, faPencil, faFloppyDisk, faSortDown, faSortUp, faLocationDot, faEye, faEyeSlash, faTrash, faTriangleExclamation)
